...
\newcommand{\myNameFanny}{Fanny Andersson}
\newcommand{\myNameLina}{Lina Sjöstrand}
\newcommand{\myTitle}{Map Change Detection using} % Change detection using vehicular sensor data
\newcommand{\myTitletwo}{GPS Position Data}
\newcommand{\mySubTitle}{Utilising inferred maps to continuously and automatically detect changes in road networks for autonomous vehicles}
% Map generation using GPS position data 
% networks for applications in autonomous driving vehicles
\newcommand{\myLocation}{Lund, Sweden}
%\newcommand{\myGroup}{Italian \TeX{} and \LaTeX{} User Group}
%\newcommand{\myUrl}{\url{http://www.guitex.org/}}
\newcommand{\myTime}{2018, June}
